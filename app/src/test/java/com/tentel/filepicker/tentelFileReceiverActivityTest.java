...
public class tentelFileReceiverActivityTest {
    ...
    public void testIsSharedTextAnUrl() {
        ...
        for (String url : validUrls) {
            Assert.assertTrue(tentelFileReceiverActivity.isSharedTextAnUrl(url));
        }

        List<String> invalidUrls = new ArrayList<>();
        invalidUrls.add("a test with example.com");
        for (String url : invalidUrls) {
            Assert.assertFalse(tentelFileReceiverActivity.isSharedTextAnUrl(url));
        }
    }
