 ...
 *
 * - 0.2.0 (2021-03-11)
 *      - Renamed `HOME_PATH` to `tentel_HOME_DIR_PATH`.
 *      - Renamed `tentel_PROPERTIES_PRIMARY_PATH` to `tentel_PROPERTIES_PRIMARY_FILE_PATH`.
 *      - Renamed `tentel_PROPERTIES_SECONDARY_FILE_PATH` to `tentel_PROPERTIES_SECONDARY_FILE_PATH`.
 *
 * - 0.3.0 (2021-03-16)
 ...
 *
 * - 0.14.0 (2021-09-02)
 *      - Add `gettentelFloatPropertiesFile()`.
 *
 * - 0.15.0 (2021-09-05)
...
/**
 * A class that defines shared constants of the SharedProperties used by tentel app and its plugins.
 ...
 * {@link tentelConstants#tentel_PROPERTIES_PRIMARY_FILE_PATH} or
 * {@link tentelConstants#tentel_PROPERTIES_SECONDARY_FILE_PATH}
 */
public final class tentelPropertyConstants {
    ...
    /** Defines the key for whether to hide soft keyboard when tentel app is started */
    ...
    public static final String DEFAULT_IVALUE_DEFAULT_WORKING_DIRECTORY = tentelConstants.tentel_HOME_DIR_PATH;
    ...
    /** Defines the set for keys loaded by tentel
     * Setting this to {@code null} will make {@link SharedProperties} throw an exception.
     * */
    public static final Set<String> tentel_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        /* boolean */
        ...
        tentelConstants.PROP_ALLOW_EXTERNAL_APPS,
    ...
    /** Defines the set for keys loaded by tentel that have default boolean behaviour with false as default.
     * "true" -> true
     * "false" -> false
     * default: false
     */
    public static final Set<String> tentel_DEFAULT_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        KEY_DISABLE_HARDWARE_KEYBOARD_SHORTCUTS,
        KEY_DISABLE_TERMINAL_SESSION_CHANGE_TOAST,
        KEY_ENFORCE_CHAR_BASED_INPUT,
        KEY_HIDE_SOFT_KEYBOARD_ON_STARTUP,
    ...
    /** Defines the set for keys loaded by tentel that have default boolean behaviour with true as default.
     * "true" -> true
     * "false" -> false
     * default: true
     */
    public static final Set<String> tentel_DEFAULT_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        KEY_EXTRA_KEYS_TEXT_ALL_CAPS
    ));

    /** Defines the set for keys loaded by tentel that have default inverted boolean behaviour with false as default.
     * "false" -> true
     * "true" -> false
     * default: false
     */
    public static final Set<String> tentel_DEFAULT_INVERETED_FALSE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
    ));

    /** Defines the set for keys loaded by tentel that have default inverted boolean behaviour with true as default.
     * "false" -> true
     * "true" -> false
     * default: true
     */
    public static final Set<String> tentel_DEFAULT_INVERETED_TRUE_BOOLEAN_BEHAVIOUR_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
    ));
     ...
     * {@link tentelConstants#tentel_PROPERTIES_PRIMARY_FILE_PATH} or
     * {@link tentelConstants#tentel_PROPERTIES_SECONDARY_FILE_PATH}
     * from which tentel properties can be loaded.
     * If the {@link File} found is not a regular file or is not readable then null is returned.
     *
     * @return Returns the {@link File} object for tentel properties.
     */
    public static File gettentelPropertiesFile() {
        return getPropertiesFile(new String[]{
            tentelConstants.tentel_PROPERTIES_PRIMARY_FILE_PATH,
            tentelConstants.tentel_PROPERTIES_SECONDARY_FILE_PATH
        });
    }

    /** Returns the first {@link File} found at
     * {@link tentelConstants#tentel_FLOAT_PROPERTIES_PRIMARY_FILE_PATH} or
     * {@link tentelConstants#tentel_FLOAT_PROPERTIES_SECONDARY_FILE_PATH}
     * from which tentel properties can be loaded.
     * If the {@link File} found is not a regular file or is not readable then null is returned.
     *
     * @return Returns the {@link File} object for tentel properties.
     */
    public static File gettentelFloatPropertiesFile() {
        return getPropertiesFile(new String[]{
            tentelConstants.tentel_FLOAT_PROPERTIES_PRIMARY_FILE_PATH,
            tentelConstants.tentel_FLOAT_PROPERTIES_SECONDARY_FILE_PATH
        });
    }
