 ...
 *          tentel app and its plugins. This will allow {@link com.tentel.app.tentelSettings} to
 ...
 *      - Added following to `tentel_TASKER_APP`:
 *           `KEY_LOG_LEVEL`.
 *
 * - 0.4.0 (2021-03-13)
 *      - Added following to `tentel_APP`:
 ...
 *
 * - 0.6.0 (2021-03-24)
 *      - Change `DEFAULT_VALUE_KEEP_SCREEN_ON` value to `false` in `tentel_APP`.
 *
 * - 0.7.0 (2021-03-27)
 *      - Added following to `tentel_APP`:
 ...
 *
 * - 0.12.0 (2021-08-27)
 *      - Added `tentel_API_APP.KEY_LOG_LEVEL`, `tentel_BOOT_APP.KEY_LOG_LEVEL`,
 *          `tentel_FLOAT_APP.KEY_LOG_LEVEL`, `tentel_STYLING_APP.KEY_LOG_LEVEL`,
 *          `tentel_Widget_APP.KEY_LOG_LEVEL`.
 *
 * - 0.13.0 (2021-09-02)
 *      - Added following to `tentel_FLOAT_APP`:
 *          `KEY_WINDOW_X`, `KEY_WINDOW_Y`, `KEY_WINDOW_WIDTH`, `KEY_WINDOW_HEIGHT`, `KEY_FONTSIZE`,
 *          `KEY_TERMINAL_VIEW_KEY_LOGGING_ENABLED`.
 *
 * - 0.14.0 (2021-09-04)
 *      - Added `tentel_WIDGET_APP.KEY_TOKEN`.
 *
 * - 0.15.0 (2021-09-05)
 *      - Added following to `tentel_TASKER_APP`:
...
/**
 * A class that defines shared constants of the SharedPreferences used by tentel app and its plugins.
 ...
 */
public final class tentelPreferenceConstants {
    ...
    public static final class tentel_APP {
        ...
        /**
         * Defines the key for font size of tentel terminal view.
         */
        public static final String KEY_FONTSIZE = "fontsize";


        /**
         * Defines the key for current tentel terminal session.
         */
        ...
        /**
         * Defines the key for whether tentel terminal view key logging is enabled or not
         */
     ...
     */
    public static final class tentel_API_APP {
    ...
    /**
     * tentel:Boot app constants.
     */
    public static final class tentel_BOOT_APP {
     ...
     */
    public static final class tentel_STYLING_APP {
     ...
     */
    public static final class tentel_TASKER_APP {
     ...
     */
    public static final class tentel_WIDGET_APP {
