package com.tentel.shared.activities;
 ...
 * {@code `<activity android:name="com.tentel.shared.activities.ReportActivity" android:theme="@style/Theme.AppCompat.tentelReportActivity" android:documentLaunchMode="intoExisting" />` }
 * and
 * {@code `<receiver android:name="com.tentel.shared.activities.ReportActivity$ReportActivityBroadcastReceiver"  android:exported="false" />` }
    ...
    private void updateUI() {
        ...
        if (actionBar != null) {
            if (mReportInfo.reportTitle != null)
                ...
                actionBar.setTitle(tentelConstants.tentel_APP_NAME + " App Report");
        }
