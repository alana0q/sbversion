package com.tentel.shared.models;
...
public class ExecutionCommand {
    ...
    Only the {@link #errCode} being non-zero means that execution command failed from the tentel app
    perspective.
    */
    ...
    /**
     * The {@link ExecutionCommand} custom log level for background {@link com.tentel.shared.shell.tentelTask}
     * commands. By default, @link com.tentel.shared.shell.StreamGobbler} only logs stdout and
     * stderr if {@link Logger} `CURRENT_LOG_LEVEL` is >= {@link Logger#LOG_LEVEL_VERBOSE} and
     * {@link com.tentel.shared.shell.tentelTask} only logs stdin if `CURRENT_LOG_LEVEL` is >=
    ...
    /** Defines the markdown text for the help of the tentel plugin API that was used to start the
     ...
     * like with an intent or from within tentel app itself. */
